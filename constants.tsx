...
export const HABIT_TYPE_COLORS: Record<HabitType, string> = {
  [HabitType.Study]: 'bg-indigo-100 text-indigo-700',
  [HabitType.Fitness]: 'bg-orange-100 text-orange-700',
  [HabitType.Life]: 'bg-emerald-100 text-emerald-700',
  [HabitType.Work]: 'bg-blue-100 text-blue-700',
};

export const MOCK_GROUPS = [
  { id: '1', name: 'Early Birds Club', description: 'Wake up at 5AM daily!', members: 128, isJoined: false },
  { id: '2', name: '100 Days of Code', description: 'Commit code every day.', members: 4320, isJoined: true },
  { id: '3', name: 'Yoga Masters', description: 'Daily stretching and peace.', members: 85, isJoined: false },
];

export const MOCK_FEED = [
  { id: '1', userName: 'Alice', action: 'completed', habitTitle: 'Morning Jog', timeAgo: '5m', likes: 12, comments: 2, isLiked: false },
  { id: '2', userName: 'Bob', action: 'completed', habitTitle: 'Read 30 mins', timeAgo: '1h', likes: 45, comments: 5, isLiked: true },
  { id: '3', userName: 'Charlie', action: 'streak', habitTitle: 'Drink Water (7 day streak!)', timeAgo: '2h', likes: 89, comments: 12, isLiked: false },
];
